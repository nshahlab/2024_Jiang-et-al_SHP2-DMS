...
for filename in os.listdir(directory):
	if filename.endswith(".pdb"):
		myfile = open(filename[:-4] + '_R111-E250.txt', 'w')
		structure = parser.get_structure(filename[:-4], filename)
		for model in structure:
			for chain in model:
				dist01 = chain[111+1]["NH1"] - chain[250+1]["OE1"]
				dist02 = chain[111+1]["NH1"] - chain[250+1]["OE2"]
				dist03 = chain[111+1]["NH2"] - chain[250+1]["OE1"]
				dist04 = chain[111+1]["NH2"] - chain[250+1]["OE2"]
